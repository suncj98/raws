...
.agent-tooltip {\
  font-size: 12px;\
  font-weight: bold;\
  color: white;                   /* 字体颜色为白色，以便在深色背景上清晰显示 */\
  background-color: rgba(0, 0, 0, 0.5);  /* 半透明黑色背景 */\
  padding: 2px 6px;               /* 为提示框增加一些内边距 */\
  border-radius: 4px;             /* 圆角边框，使提示框更加美观 */\
  border: none;                   /* 无边框 */\
...
// 为 OverlappingMarkerSpiderfier 注册
window.registerMarkerForOMS(m);

// jQueryUI doesn’t 自动检测新标记
if (!isTouchDev) {
